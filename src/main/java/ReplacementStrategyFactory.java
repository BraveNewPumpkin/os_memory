...
//        {"ws", "Working Set"}
    ...
    public ReplacementStrategyFactory(InputData input_data, MemoryManager memory_manager) {
    ...
    public ReplacementStrategy getStrategyObject(String name) {
        ...
        if (name.equalsIgnoreCase("fifo")) {
            replacement_strategy = new FifoReplacementStrategy(name, input_data, memory_manager);
        } else if (name.equalsIgnoreCase("lru")) {
            replacement_strategy = new LruReplacementStrategy(name, input_data, memory_manager);
        } else if (name.equalsIgnoreCase("lfu")) {
            replacement_strategy = new LfuReplacementStrategy(name, input_data, memory_manager);
        } else if (name.equalsIgnoreCase("opt")) {
            replacement_strategy = new OptReplacementStrategy(name, input_data, memory_manager);
        } else if (name.equalsIgnoreCase("ws")) {
            replacement_strategy = new WsReplacementStrategy(name, input_data, memory_manager);
        } else {
